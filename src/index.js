...
import RegistryNetworks from 'singularitynet-alpha-blockchain/networks/Registry.json';
import RegistryAbi from 'singularitynet-alpha-blockchain/abi/Registry.json'
